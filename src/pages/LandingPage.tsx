...
import { ArrowRight, FolderKanban, Hand, Globe, Sparkles } from 'lucide-react';
...
const FEATURES = [
    {
        icon: Hand,
        title: 'Arraste e dê zoom',
        body: 'Navegue séculos com pan e zoom fluidos no canvas.',
    },
    {
        icon: Sparkles,
        title: 'Períodos e eventos',
        body: 'Camadas coloridas, imagens e detalhes ao passar o mouse.',
    },
    {
        icon: Globe,
        title: 'Tudo no navegador',
        body: `${PORTFOLIO_TAGLINE} — sem conta e sem servidor.`,
    },
] as const;
                ...
                <section className="relative flex min-h-screen flex-col justify-end overflow-hidden pb-10 sm:justify-center sm:pb-0">
                    ...
                    <div className="relative z-10 mx-auto w-full max-w-6xl px-6 pt-24 pb-16 sm:pt-0">
                        ...
                        <p className="animate-hero-rise-delay-2 mt-3 max-w-md text-base text-muted-foreground sm:text-lg">
                            Arraste, dê zoom e conte histórias em um canvas vivo — sem backend, sem
                            conta.
                        </p>
                ...
                <section className="relative border-t border-border/70 bg-[radial-gradient(ellipse_70%_60%_at_50%_0%,oklch(0.72_0.08_185/0.1),transparent_70%)]">
                    <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24">
                        <h2 className="font-heading text-3xl tracking-tight text-ink sm:text-4xl">
                            Um canvas para contar histórias
                        </h2>
                        <p className="mt-3 max-w-lg text-muted-foreground">
                            O produto é a própria timeline — abra a demo e sinta o ritmo do zoom,
                            das camadas e dos cartões de detalhe.
                        </p>
